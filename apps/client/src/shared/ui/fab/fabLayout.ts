...
export const mobileFabScrollReserveClassName =
  'max-md:pb-[calc(2.5rem+env(safe-area-inset-bottom))]';

export const fabWrapClassName =
  'fixed end-0 bottom-0 z-40 p-3 pb-[calc(0.75rem+env(safe-area-inset-bottom))] pe-[max(0.5rem,env(safe-area-inset-right))] md:hidden';
