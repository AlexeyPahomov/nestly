...
-- -----------------------------------------------------------------------------
-- 3. CategoryMonthSnapshot (closing_balance persisted via recompute only)
-- -----------------------------------------------------------------------------
...
-- -----------------------------------------------------------------------------
-- 4. MonthCloseReport (immutable summary at close)
-- -----------------------------------------------------------------------------
...
-- -----------------------------------------------------------------------------
-- 5. Allocation: type + period_month (denormalized budget period)
-- -----------------------------------------------------------------------------
...
-- DROP INDEX "Allocation_user_id_period_month_idx";
-- ALTER TABLE "Allocation" DROP COLUMN "period_month", DROP COLUMN "type";
-- DROP TABLE "MonthCloseReport";
-- DROP TABLE "CategoryMonthSnapshot";
-- DROP TABLE "BudgetMonth";
-- DROP TYPE "AllocationType";
-- DROP TYPE "BudgetMonthStatus";
-- =============================================================================
